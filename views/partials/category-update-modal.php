    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                <h1 class="modal-title fs-5" id="updateCategoryLabel">Edit Kategori</h1>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                <div class="">
                    <form action="/dashboard/category/update" method="POST">
                        ...
                        <div class="d-flex flex-col mb-1">
                            ...
                            <input type="text" class="input text-sm p-1 m-0" id="update-category-name" name="categoryName">
                        </div>
